...
def download_vlcs(data_dir):
    ...
    download_and_extract(
        "https://drive.google.com/uc?id=1skwblH1_okBwxWxmRsp9_qi15hyPpxg8", os.path.join(data_dir, "VLCS.tar.gz")
    )
...
def download_pacs(data_dir):
    ...
    download_and_extract(
        "https://drive.google.com/uc?id=0B6x7gtvErXgfbF9CSk53UkRxVzg", os.path.join(data_dir, "PACS.zip")
    )
...
def download_office_home(data_dir):
    ...
    download_and_extract(
        "https://drive.google.com/uc?id=0B81rNlvomiwed0V1YUxQdC1uOTg", os.path.join(data_dir, "office_home.zip")
    )
...
def download_sviro(data_dir):
    ...
    download_and_extract(
        "https://sviro.kl.dfki.de/?wpdmdl=1731", os.path.join(data_dir, "sviro_grayscale_rectangle_classification.zip")
    )
