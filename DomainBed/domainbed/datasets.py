    ...
    def __init__(self, root, test_envs, hparams):
        ...
        for _ in [0, 1, 2]:
            self.datasets.append(
                TensorDataset(torch.randn(16, *self.INPUT_SHAPE), torch.randint(0, self.num_classes, (16,)))
            )
    ...
    def rotate_dataset(self, images, labels, angle):
        rotation = transforms.Compose(
            [
                ...
                transforms.Lambda(
                    lambda x: rotate(
                        x, angle, fill=(0,), interpolation=torchvision.transforms.InterpolationMode.BILINEAR
                    )
                ),
                transforms.ToTensor(),
            ]
...
class VLCS(MultipleEnvironmentImageFolder):
    ...
    def __init__(self, root, test_envs, hparams):
        self.dir = os.path.join(root, "VLCS/Raw images/")
...
class PACS(MultipleEnvironmentImageFolder):
    ...
    def __init__(self, root, test_envs, hparams):
        self.dir = os.path.join(root, "PACS/Raw images/")
        super().__init__(self.dir, test_envs, hparams["data_augmentation"], hparams)
...
class DomainNet(MultipleEnvironmentImageFolder):
    ...
    def __init__(self, root, test_envs, hparams):
        self.dir = os.path.join(root, "DomainNet/Raw images/")
        super().__init__(self.dir, test_envs, hparams["data_augmentation"], hparams)
...
class OfficeHome(MultipleEnvironmentImageFolder):
    ...
    def __init__(self, root, test_envs, hparams):
        self.dir = os.path.join(root, "OfficeHome/Raw images/")
        super().__init__(self.dir, test_envs, hparams["data_augmentation"], hparams)
